...
const FilterItem = _ref => {
  ...
  }, filterKeyName), /*#__PURE__*/React.createElement("div", {
    className: `gallery-filter-dropdown-content ${isOpen ? 'open' : ''}`
  }, filterList.map(option => /*#__PURE__*/React.createElement("div", {
...
const Card = _ref => {
  ...
  }, ownerLabel || owner.slice(0, 5) + '...' + owner.slice(owner.length - 4, owner.length))) : '', isMarketplace && card.marketplace && /*#__PURE__*/React.createElement("div", {
    className: "gallery-card-price-holder"
  }, (card.marketplace.sale_native && card.marketplace.sale_native > 0 || card.marketplace.sale_erc777 && card.marketplace.sale_erc777 > 0) && /*#__PURE__*/React.createElement("span", {
    className: "gallery-card-label-title"
  ...
  }, openseaUrl && /*#__PURE__*/React.createElement("img", {
    src: img$6,
    alt: "opensea",
    style: {
      maxWidth: '30px',
  ...
  }), etherscanUrl && /*#__PURE__*/React.createElement("img", {
    src: img$5,
    alt: "etherscan",
    style: {
      maxWidth: '30px',
...
var Explorer = function Explorer(_ref) {
  ...
  }, loading ? /*#__PURE__*/React.createElement("p", null, "Fetching data ....") : /*#__PURE__*/React.createElement(ScrollComponent, {
    nfts: nfts,
    openseaUrl: openseaUrl,
    etherscanUrl: etherscanUrl,
    handleCardClick: handleCardClick,
...
const SelectedFilterItem = _ref => {
  ...
  }, filterKeyName, ":", ' '), /*#__PURE__*/React.createElement("span", {
...
var GalleryComponent = function GalleryComponent(_ref) {
  ...
  }, /*#__PURE__*/React.createElement(FilterContextProvider, null, apiBaseUrl && displayFilters ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Filter$1, {
    baseUrl: apiBaseUrl,
    headerStyle: headerStyle
  }), displaySelectedFilters && /*#__PURE__*/React.createElement(SelectedFilters$1, null)) : null, /*#__PURE__*/React.createElement(Explorer, {
    baseUrl: apiBaseUrl,
    openseaUrl: openseaUrl,
    etherscanUrl: etherscanUrl,
    handleCardClick: handleCardClick,
