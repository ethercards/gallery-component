      ...
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return _context2.abrupt("return", new Promise(function (resolve, reject) {
            axios.post("".concat(base_url, "/filter"), filters).then(function (response) {
              resolve(response.data);
            }).catch(function (e) {
              reject(e.message);
            });
...
var Image = styled.img(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  //display: block;\n  //height: 100px;\n  //width: 100px;\n  // Add a smooth animation on loading\n  @keyframes loaded {\n    0% {\n      opacity: 0.1;\n    }\n    100% {\n      opacity: 1;\n    }\n  }\n  // I use utilitary classes instead of props to avoid style regenerating\n  &.loaded:not(.has-error) {\n    animation: loaded 300ms ease-in-out;\n  }\n  &.has-error {\n    // fallback to placeholder image on error\n    content: url(", ");\n  }\n"])), placeHolder);
...
var Explorer = function Explorer(_ref) {
  ...
  console.log(nfts);
  return /*#__PURE__*/React.createElement("div", null, loading ? /*#__PURE__*/React.createElement("p", null, "....Loading") : null, /*#__PURE__*/React.createElement(ScrollComponent, {
    nfts: nfts
  }));
};
