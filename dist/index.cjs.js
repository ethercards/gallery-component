...
const Card = _ref => {
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", {
  ...
  }, /*#__PURE__*/React__default["default"].createElement("p", null, card.marketplace.sale_native.length > 9 ? card.marketplace.sale_native.slice(0, 7) + '...' : card.marketplace.sale_native), chainDefaultToken.toLowerCase().includes('eth') ? /*#__PURE__*/React__default["default"].createElement("img", {
    src: img$4,
    alt: "ETH",
    ...
    className: "gallery-card-content-id-box gallery-price-box"
  }, /*#__PURE__*/React__default["default"].createElement("p", null, card.marketplace.sale_erc777.length > 9 ? card.marketplace.sale_erc777.slice(0, 7) + '...' : card.marketplace.sale_erc777), erc777Symbol.toLowerCase().includes('dust') ? /*#__PURE__*/React__default["default"].createElement("img", {
    src: img$2,
    alt: "DUST",
    className: "gallery-card-token-symbol"
  }) : /*#__PURE__*/React__default["default"].createElement("img", {
  ...
  })) : null, card.traits && displayTraits && /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, card.traits.findIndex(e => e.status === "1") > -1 && /*#__PURE__*/React__default["default"].createElement("span", {
    className: "gallery-card-label-title"
